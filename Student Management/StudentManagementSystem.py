...
# 🧩 Problem Statement
# You are asked to build a Student Management System using Python.
# The system should store student details, perform operations, handle errors, and save data in a file.
...
class CollegeStudent(Student):
    def __init__(self, student_id, name, age, marks, department, year):
        super().__init__(self, student_id, name, age, marks)
